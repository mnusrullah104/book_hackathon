# Data Model: Docusaurus Purple Theme Upgrade

## Theme Configuration Entity

**Fields**:
- `themeType`: String (light | dark) - Current active theme
- `purpleColorScheme`: Object - Purple-based color variables for the active theme
- `typographySettings`: Object - Font sizes, line heights, spacing values for book-like reading
...
- `chapterNumber`: String - Numbered format (e.g., "1.1", "1.2", etc.) for book-like structure
...
**Fields**:
- `aboutPageId`: String - Unique identifier for the about page
- `pageTitle`: String - Title of the about page
- `bookPurpose`: String - Explanation of the book's purpose
- `authorBackground`: String - Information about author/project background
- `hackathonContext`: String - Information about hackathon context
- `content`: String - Full content of the about page

**Relationships**:
- Linked to navigation structure as a top-level page
- Connected to site-wide styling and theme
...
- Chapter numbering must follow the required format (1.1, 1.2, etc.)
