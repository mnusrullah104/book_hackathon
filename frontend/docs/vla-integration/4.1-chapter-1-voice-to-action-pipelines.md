...
## Cross-References
- Continue to [Chapter 2: Cognitive Planning with LLMs](./4.2-chapter-2-cognitive-planning-with-llms.md) to learn about LLM-based planning
- For system integration concepts, see [Chapter 3: Capstone — The Autonomous Humanoid](./4.3-chapter-3-capstone-autonomous-humanoid.md)
