...
## Cross-References
- Continue to [Chapter 2: Isaac ROS for Perception and VSLAM](./3.2-chapter-2-isaac-ros-perception-vslam.md) to learn about perception systems
- For navigation concepts, see [Chapter 3: Navigation with Nav2 for Humanoids](./3.3-chapter-3-navigation-with-nav2-humanoids.md)
