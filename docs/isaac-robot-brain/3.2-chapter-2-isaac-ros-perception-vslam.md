...
## Cross-References
- Continue to [Chapter 3: Navigation with Nav2 for Humanoids](./chapter-3-navigation-with-nav2-humanoids.md) to learn about navigation
- Building on simulation concepts from [Chapter 1: Isaac Sim Fundamentals](./chapter-1-isaac-sim-fundamentals.md)
