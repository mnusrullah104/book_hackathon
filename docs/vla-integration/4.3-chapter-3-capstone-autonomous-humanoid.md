...
## Cross-References
- Review [Chapter 1: Voice-to-Action Pipelines](./chapter-1-voice-to-action-pipelines.md) for natural language processing concepts
- Review [Chapter 2: Cognitive Planning with LLMs](./chapter-2-cognitive-planning-with-llms.md) for planning and reasoning concepts
