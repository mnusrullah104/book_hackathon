...
## Cross-References
- Continue to [Chapter 3: Capstone — The Autonomous Humanoid](./chapter-3-capstone-autonomous-humanoid.md) to learn about complete system integration
- Building on voice interfaces from [Chapter 1: Voice-to-Action Pipelines](./chapter-1-voice-to-action-pipelines.md)
