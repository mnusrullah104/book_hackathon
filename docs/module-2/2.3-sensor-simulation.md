...
:::info See Also
For understanding the physics simulation that affects sensor behavior, see [Chapter 1: Physics Simulation with Gazebo](./2.1-physics-simulation-gazebo.md). To learn about creating environments where these sensors operate, see [Chapter 2: Environment & Interaction Design in Unity](./2.2-environment-unity.md).
:::
