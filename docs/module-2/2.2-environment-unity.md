...
:::info See Also
For understanding the physics simulation that underlies these environments, see [Chapter 1: Physics Simulation with Gazebo](./physics-simulation-gazebo.md). To learn about sensor simulation in these environments, see [Chapter 3: Sensor Simulation for Robots](./sensor-simulation.md).
:::
